...
contains
  ...
  subroutine input_chan
    ...
    read (11, *)
    read (11, *) r0, alpha_e, b0, cent_x, cent_z
    read (11, *)
    ...
    read (11, *)
    read (11, *) Nb, Nphi, b_factor, phiv_factor, phic_factor
    read (11, *)
    read (11, *) alpha_m, beta_m, tau_m, q0, phiv_min, phic_min, w_sediment
    read (11, *)
    ...
    !phiv_min = 1.d-5
    phiv_max = phiv_factor * 5.d0*F0 / (3.d0*alpha_e) * ((0.9d0 * alpha_e * F0)**(-1.d0/3.d0)) * &
                              ((H + 5.d0*r0/(6.d0*alpha_e))**(-5.d0/3.d0))
    !phic_min = 1.d-4
    phic_max = phic_factor * 5.d0*F0 / (3.d0*alpha_e) * ((0.9d0 * alpha_e * F0)**(-1.d0/3.d0)) * &
                              ((H + 5.d0*r0/(6.d0*alpha_e))**(-5.d0/3.d0))
