module flow
  ...
  real(rkind), pointer, contiguous, dimension(:,:,:) :: u1,u2,u3,p,r1,r2,r3,f1,f2,f3,s1,s2,s3,s4,s5, s6, &
                                                           ...
                                                           th_sfluc, nlwf_xz_dtmem, &
                                                           nlwf_yz_dtmem, nlwf_xz_dt, nlwf_yz_dt
  ...
  complex(rkind), pointer, contiguous, dimension(:,:,:) :: cu1,cu2,cu3,cp,cr1,cr2,cr3,cf1,cf2,cf3, &
                                                           ...
                                                           cnlwf_xz_dtmem, cnlwf_yz_dtmem, &
                                                           cnlwf_xz_dt, cnlwf_yz_dt
...
contains
  ...
  subroutine allocate_all
    ...
    call alloc_array3D(nlwf_xz_dt, cnlwf_xz_dt)
    call alloc_array3D(nlwf_yz_dt, cnlwf_yz_dt)
    call alloc_array3D(nlwf_xz_dtmem, cnlwf_xz_dtmem)
    call alloc_array3D(nlwf_yz_dtmem, cnlwf_yz_dtmem)
