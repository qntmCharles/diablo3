module flow
  ...
  ! 4D
  real(rkind), pointer, contiguous, dimension(:,:,:,:) :: th,fth,rth, th_mem, th_forcing
...
contains
  ...
  subroutine read_flow
    ...
    if (rank == 0) then
      ...
      gname = 'Ent_b_flux_mem'
      call ReadHDF5_plane(fname, gname, Ent_b_flux_mem)
      gname = 'Ent_b_flux_cum'
      call ReadHDF5_plane(fname, gname, Ent_b_flux_cum)
      ...
      gname = 'F_phimin_mem'
      call ReadHDF5_plane(fname, gname, F_phimin_mem)
      gname = 'F_phimin_int'
      call ReadHDF5_plane(fname, gname, F_phimin_int)

      gname = 'cw_source_mem'
      call ReadHDF5_plane(fname, gname, cweights_source_mem)
      gname = 'cw_source_cum'
      call ReadHDF5_plane(fname, gname, cweights_source_cum)
    end if
  ...
  subroutine save_flow(final)
    ...
    if (rank == 0) then
      ...
      gname = 'Ent_b_flux_mem'
      call WriteHDF5_plane(fname, gname, Ent_b_flux_mem)
      gname = 'Ent_phi_flux_cum'
      call WriteHDF5_plane(fname, gname, Ent_phi_flux_cum)
      gname = 'Ent_phi_flux_mem'
      call WriteHDF5_plane(fname, gname, Ent_phi_flux_mem)
      gname = 'F_phimin_mem'
      call WriteHDF5_plane(fname, gname, F_phimin_mem)
      gname = 'F_phimin_int'
      call WriteHDF5_plane(fname, gname, F_phimin_int)

      gname = 'cw_source_mem'
      call WriteHDF5_plane(fname, gname, cweights_source_mem)
      gname = 'cw_source_cum'
