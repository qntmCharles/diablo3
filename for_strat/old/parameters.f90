module parameters
  ...
  real(rkind), pointer, contiguous, dimension(:,:) :: Ent_flux, Ent_phi_flux_mem, Ent_phi_flux_cum, Ent_phi_flux
  real(rkind), pointer, contiguous, dimension(:,:) :: Ent_b_flux_mem, Ent_b_flux_cum, Ent_b_flux
  real(rkind), pointer, contiguous, dimension(:,:) :: F_phimin, F_phimin_int, F_phimin_mem
  real(rkind), pointer, contiguous, dimension(:,:) :: cweights, cweights_source, cweights_source_cum, cweights_source_mem
  ...
  real(rkind) chi_min, chi_max, Ri_min, Ri_max, Re_b_min, Re_b_max, tked_min, tked_max, N2_min, N2_max
...
contains
  ...
  subroutine input_chan
    ...
    read (11, *)
    read (11, *) tked_min, tked_max
    read (11, *)
    read (11, *) N2_min, N2_max
    ...
    allocate (F_phimin(1:Nb_out, 1:Nphi_out))
    allocate (F_phimin_int(1:Nb_out, 1:Nphi_out))
    allocate (F_phimin_mem(1:Nb_out, 1:Nphi_out))

    allocate (Ent_phi_flux_cum(1:Nb_out, 1:Nphi_out))
    allocate (Ent_flux(1:Nb_out, 1:Nphi_out))
    allocate (Ent_phi_flux(1:Nb_out, 1:Nphi_out))
    allocate (Ent_b_flux(1:Nb_out, 1:Nphi_out))
    allocate (Ent_b_flux_mem(1:Nb_out, 1:Nphi_out))
    allocate (Ent_b_flux_cum(1:Nb_out, 1:Nphi_out))
    ...
    allocate (cweights(1:Nb, 1:Nphi))
    allocate (cweights_source(1:Nb, 1:Nphi))
    allocate (cweights_source_cum(1:Nb, 1:Nphi))
    allocate (cweights_source_mem(1:Nb, 1:Nphi))

    weights_flux_mem = 0.d0
    Ent_b_flux_mem = 0.d0
    Ent_phi_flux_mem = 0.d0
    F_phimin_mem = 0.d0
    cweights_source_mem = 0.d0
