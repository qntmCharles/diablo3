...
#ax[0].set_title("Buoyancy Reynolds number $\mathrm{{Re}}_b$")
field_norm = plt.Normalize(0, f_thresh)
...
plt.colorbar(field_im_thresh, cax=cax, label="Buoyancy Reynolds number (log)")
...
#plt.tight_layout()
plt.savefig('/home/cwp29/Documents/essay/figs/Re_b_vol.png', dpi=300)
plt.show()
