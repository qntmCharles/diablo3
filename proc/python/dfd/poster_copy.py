...
fig8, axs8 = plt.subplots(1,2, figsize=(9, 3), constrained_layout=True)

im_W = axs8[0].pcolormesh(sx, sy, W_thresh[steps[-1]], cmap='plasma', alpha=0.7)
...
cb_W = fig8.colorbar(im_W, ax = axs8[0], label=r"$W$", shrink=0.5)
cb_W.set_label("$W$", rotation=0, labelpad=10)
...
cb_S = fig6.colorbar(im_S, ax=axs8[1], label=r"$S$", shrink=0.5)
